...
public class GistDAO
{
	 ...
	 * @param authenticator provides authentication to github. Use <b>null</b> to skip authentication, but be ready to catch exceptions.
	 * @param content contents of the file. 
	 * @param description description of the file
	 * @param fileName file name. Nonnull,not empty.
	 * @return
	 * @throws PreferenceStorageException
	 */
    public static Gist createGist(Authenticator authenticator, String content, String description, String fileName) throws PreferenceStorageException
    {
	...
	private static Gist createPublicGist(String content, String description, String fileName) throws PreferenceStorageException {
		...
		{
			throw new PreferenceStorageException("Cannot create public gist. Reason:" +exception.getMessage(), exception);
		}
		return gist;
	}
	...
	private static Gist createPrivateGist(Authenticator authenticator, String content, String description,
		...
		{
			throw new PreferenceStorageException("Cannot create private gist. Reason:" +exception.getMessage(), exception);
		}
		return gist;
	}
     ...
     * @param authenticator provides an authentication token. Use <b>null</b> to try to do this operation publicly.
     * @param gist gist to update. Nonnull.
     * @return
     * @throws PreferenceStorageException
     */
	...
	private static Gist updateGistPublicly(Gist gist) throws PreferenceStorageException {
		...
		{
			throw new PreferenceStorageException("Cannot update publicly gist. Reason: "+ exception.getMessage(), exception);
		}
		return updatedGist;
	}
	...
	private static Gist updateGistPrivately(Authenticator authenticator, Gist gist) throws PreferenceStorageException {
		...
		{
			throw new PreferenceStorageException("Cannot update privately gist. Reason: "+ exception.getMessage(), exception);
		}
		return updatedGist;
	}
}
